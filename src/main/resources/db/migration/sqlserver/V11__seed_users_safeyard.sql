...
SELECT
    ...
    WHERE NOT EXISTS (
    SELECT 1 FROM users WHERE email = 'admin@safeyard.com'
);
...
SELECT
    ...
    '$2a$10$uQkXULE4zq9BKBFSzPN5veY2ZCtkXp/eSqZPhJpGjE5CBHAJeX8aUi'
    WHERE NOT EXISTS (
    SELECT 1 FROM users WHERE email = 'func@safeyard.com'
);
...
SELECT
    ...
    '$2a$10$uQkXULE4zq9BKBFSzPN5veY2ZCtkXp/eSqZPhJpGjE5CBHAJeX8aUi'
    WHERE NOT EXISTS (
    SELECT 1 FROM users WHERE email = 'cliente@safeyard.com'
);
